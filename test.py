...
parser.add_argument('--model', type=str, default="FRRN-A", required=True, help='The model you are using')
parser.add_argument('--dataset', type=str, default="TomatoDataset", required=False, help='The dataset you are using')
...
net_input = tf.compat.v1.placeholder(tf.compat.v1.float32,shape=[None,None,None,3])
net_output = tf.compat.v1.placeholder(tf.compat.v1.float32,shape=[None,None,None,num_classes]) 
