...
#Crops an image to the wanted dimensions
...
def random_crop(image, label, crop_height, crop_width):
    image = crop_center(image, 480, 256)
    label = crop_center(label, 480, 256)
    if (image.shape[0] != label.shape[0]) or (image.shape[1] != label.shape[1]):
        print("Image shape 0 = " , image.shape[0], "Image shape 1 = " , image.shape[1], "label shape 0 = " , label.shape[0], "label shape 1 = " , label.shape[1])
